				...
				Thread.sleep(5000);		
					...
					if(ProductType.contains("NV Title")){
						...
						try {
					       ...
					       driver.findElement(By.name("requestBean.siilBean.disbAmtFirst")).sendKeys(Keys.chord(Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE,Keys.BACK_SPACE)+ele);
