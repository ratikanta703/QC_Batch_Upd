			...
			for (int row = 2; row <= lastrow; row++) {
				...
				{		
					...
					for (String winHandle : driver.getWindowHandles()) {
						...
						String BalanceStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[7]/td[6]")).getText();
