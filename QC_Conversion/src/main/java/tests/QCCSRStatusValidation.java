	...
	public static void loanstatus(String SSN, String AppURL) {
		try {
         ...
         //========================= Loan Status Verification Started==============
						...
						Thread.sleep(500);
						String ClosedLoanStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[7]/td[5]")).getText();
						String NewLoanStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[9]/td[5]")).getText();
	...
	public static void twopdlloanstatus(String SSN, String AppURL) {
		try {
         ...
         //========================= Loan Status Verification Started==============
						...
						test.log(LogStatus.PASS, "Clicked on Show More Link");
						Thread.sleep(500);
						String ClosedLoanStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[8]/td[5]")).getText();
						String NewLoanStatus = driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[10]/td[5]")).getText();
