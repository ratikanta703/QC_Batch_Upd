	 ...
	 //ACH collateral details from sheet
				...
				//	test.log(LogStatus.INFO, MarkupHelper.createLabel("Transaction History validation has started", ExtentColor.BLUE));
				  ...
				  // test.log(LogStatus.PASS, "Loan Number is" + loan_nbr);
					...
					test.log(LogStatus.PASS, "Clicked on Show More Link");
					Thread.sleep(500);
					driver.findElement(By.xpath("/html/body/form[1]/table/tbody/tr/td/table/tbody/tr/td/table[2]/tbody/tr[7]/td[2]/table/tbody/tr/td/table/tbody/tr[10]/td[13]/input")).click();
