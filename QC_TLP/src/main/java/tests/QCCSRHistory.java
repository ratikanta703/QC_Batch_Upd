 ...
 public static void history(String SSN,String AppURL) throws ParseException, InterruptedException
 {
  ...
  //ACH collateral details from sheet
    ...
    //Validations
     ...
     /* String loan_account_inf_product_name= driver.findElement(locator(prop.getProperty("loan_account_inf_product_name"))).getAttribute("value");
      ...
      String loan_account_inf_inst_amt= driver.findElement(locator(prop.getProperty("loan_account_inf_inst_amt"))).getText();
      String loan_account_inf_no_of_installments= driver.findElement(locator(prop.getProperty("loan_account_inf_no_of_installments"))).getText();
...
//Loan paid to date summary
      ...
      //String cust_doc_new_balance= driver.findElement(locator(prop.getProperty("cust_doc_new_balance"))).getText();
      ...
      else
      {
       ...
       if(loan_status.trim().equalsIgnoreCase(loan_status_inf_loan_status.trim()))
       {
       ...
       if(business_date.equalsIgnoreCase(cust_transaction_date))
       {
        test.log(LogStatus.PASS, "transaction date->Expected value:"+business_date +"; == Actual value:"+cust_transaction_date);
       }
       else
       {
        test.log(LogStatus.FAIL, "transaction date->Expected value:"+business_date +"; not equals to Actual value:"+cust_transaction_date);
       }
       if(cust_tran_test.trim().equalsIgnoreCase(cust_tran.trim()))
       {
       ...
       if(cust_doc_tender_type_test.trim().equalsIgnoreCase(cust_doc_tender_type.trim())||"CHK".equalsIgnoreCase(cust_doc_tender_type.trim()))
       {
       ...
       if(ESign_CollateralType.equals("ACH"))
       {
        ...
        if(ACH_transaction.trim().equalsIgnoreCase(ach_history_ach_transaction.trim()))
        {
