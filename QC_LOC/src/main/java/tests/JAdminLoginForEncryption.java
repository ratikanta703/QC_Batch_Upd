	...
	try{
		...
		//ExcelNew TestData = new ExcelNew(System.getProperty("user.dir")+Jprop.getProperty("QC_Store_NewLoan_Test_data_sheet_path")+FileName+".xls");  		 
			...
			{		
				...
				Thread.sleep(1000);
				test.log(LogStatus.INFO,"Opened the Admin URL"+ JAdminURL);
				test.log(LogStatus.INFO,"Reading encryption details from Admin has initiated"+ JAdminURL);
