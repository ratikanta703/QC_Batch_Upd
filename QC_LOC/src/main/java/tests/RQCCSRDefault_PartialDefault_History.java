...
public class RQCCSRDefault_PartialDefault_History extends QCStore{
	...
	public static void defaultpartialdefaulthistory(String SSN,String AppURL)
	{
		try{
...
//Loan paid to date summary
					...
					/*	String loc_history_transaction_test= driver.findElement(locator(Rprop.getProperty("loc_history_transaction"))).getText();
					    ...
					    String latest_payment_date=	date1;
