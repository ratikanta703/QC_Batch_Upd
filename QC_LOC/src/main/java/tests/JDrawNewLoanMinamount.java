...
public static void LOC() throws InterruptedException
{
	...
	//OLD=====String MinLOCamount=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[5]/table/tbody/tr[5]/td[2]")).getText();
	...
	//OLD=====String MaxLOCamount=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[5]/table/tbody/tr[6]/td[2]")).getText();
	...
	test.log(LogStatus.PASS, "LOC amount enterd  as "+MinLOCamount);
		...
		{	
			...
			//*[@id="errorMessage"]/form[1]/table[1]/tbody/tr[2]/td/table/tbody/tr[3]/td/table/tbody/tr[8]/td[2]/select
			//*[@id="cardsList"]/select
...
public static void LOC_DC() throws InterruptedException
{
	if(ProductID.equals("LOC_DC"))
	{					
		rnum=rnum+1;
	...
	Thread.sleep(2000);
	LOCamount=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[3]/td[5]/table/tbody/tr[1]/td[2]")).getText();
	//LOCamount=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td[5]/table/tbody/tr[1]/td[2]")).getText();	                                      
	test.log(LogStatus.PASS, "LOC amount is : "+LOCamount);
	String interesrrate=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[5]/table/tbody/tr[2]/td[2]")).getText();
	//String interesrrate=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[2]/td[5]/table/tbody/tr[2]/td[2]")).getText();	                                               
	test.log(LogStatus.PASS, "Interest rate is : "+interesrrate);
	Thread.sleep(2000);
	String minAmountDue=driver.findElement(By.xpath("//*[@id='riskViewBdy']/table[3]/tbody/tr[1]/td/table/tbody/tr[3]/td/table/tbody/tr[4]/td[5]/table/tbody/tr[3]/td[2]")).getText();
	test.log(LogStatus.PASS, "Minimum amount due is : "+minAmountDue);
