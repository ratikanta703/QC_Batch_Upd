...
System.out.println(columnname+"_TxnHistory_FieldValue");
			       ...
			       //String repo_fee_paid2=TestData.getCellData(sheetName_calc,columnname+"_TxnHistory_FieldValue",35);
	 ...
	 //ACH collateral details from sheet
			 ...
			 //Validations
					...
					/*	String loan_balance_inf_principal_bal= driver.findElement(locator(Jprop.getProperty("loan_balance_inf_principal_bal"))).getText();
						...
						String loan_account_inf_loc_amount= driver.findElement(locator(Jprop.getProperty("loan_account_inf_loc_amount"))).getText().trim();
