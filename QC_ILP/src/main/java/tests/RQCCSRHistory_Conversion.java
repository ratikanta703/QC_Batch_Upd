...
public class RQCCSRHistory_Conversion extends QCStore{
	...
	public static void historyconversion(String SSN,String AppURL) throws ParseException, InterruptedException
	{
