	...
	public void setup() throws IOException {
		...
		try {
			...
			/*try {
				reader = new BufferedReader(
						...
						new FileReader("C:/QC_Batch11/QC_ILP/src/test/java/tests/Objects.properties"));
			...
			/*try {
				Jreader = new BufferedReader(
						...
						new FileReader("C:/QC_Batch11/QC_ILP/src/test/java/tests/JObjects.properties"));
			...
			try {
				Rreader = new BufferedReader(
						...
						new FileReader("C:/QC_Batch_191/QC_ILP/src/test/java/tests/RObjects.properties"));
		...
		/*	try {
				Areader = new BufferedReader(
						new FileReader("C:/QC_Batch11/QC_ILP/src/test/java/tests/AObjects.properties"));
			...
			/*try {
				Vreader = new BufferedReader(
						new FileReader("C:/QC_Batch11/QC_ILP/src/test/java/tests/VObjects.properties"));
