...
public static void wiilp_loandecision(String SSN,String AppURL) throws Exception
	  
	  {
			...
			Thread.sleep(1000);
			  ...
			  Thread.sleep(30000);
			  test.log(LogStatus.INFO, "******************************************************** ");
			  test.log(LogStatus.INFO, "****************** Redirecting To Dashboard Page *************************** ");
			  Thread.sleep(500); 
			  driver.findElement(By.xpath("//*[@id='submit']/div[6]/div/a/button")).click();
			  test.log(LogStatus.PASS, "Clicked on Go To Dashboard Tab" );
			  Thread.sleep(2000);
